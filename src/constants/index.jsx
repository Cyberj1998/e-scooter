import FeatureButton from '../assets/images/magictouch.svg'
import FeatureButton2 from '../assets/images/docs.svg'
import FeatureIcon from '../assets/images/feature-1.png'
import FeaturesIcon2 from '../assets/images/feature-2.png'
...
export const features = [
    {
      ...
      text: " By opting for our rental service, you contribute to reducing carbon emissions and helping the environment. Enjoy guilt-free travel through the city while promoting a greener future for everyone.",
      button: {
        icon: FeatureButton,
        title: "Become more Eco",
      },
    },
    {
      id: "1",
      icon: FeaturesIcon2,
      caption: "Convenient Mobility",
      title: "Unlock the potential",
      text: "Our electric scooters are designed for easy access and maneuverability, allowing you to navigate through traffic with ease. Perfect for short trips, our scooters make urban transport quick and efficient.",
      button: {
        icon: FeatureButton2,
  ...
  import DetailIcon from '../assets/images/detail-1.png'
  import DetailIcon2 from '../assets/images/detail-2.png'
  import DetailIcon3 from '../assets/images/detail-3.png'
  import DetailIcon4 from '../assets/images/detail-4.png'
  ...
  export const faq = [
    {
      ...
      answer:
        "To unlock a scooter, simply download our mobile app, create an account, and use the app to scan the QR code on the scooter.",
    },
    {
      id: "1",
      question: "What are the costs associated with renting a scooter?",
      answer:
        "The rental cost varies by plan, but you will typically pay a base fee to unlock the scooter and an additional charge per minute of use.",
    },
    {
      id: "2",
      question: "What should I do if my scooter is damaged?",
      answer:
        "If you find a damaged scooter, please report it through the app immediately. Do not use the scooter, and we will send a technician to address the issue.",
    },
    {
      id: "3",
      question: "Can I reserve a scooter in advance?",
      answer:
        "Currently, our service does not support advance reservations. Scooters are available on a first-come, first-serve basis.",
    },
    {
      id: "4",
      question: "Where can I park the scooter after use?",
      answer:
        "Scooters must be parked in designated parking zones, which are marked on the app. Make sure to lock the scooter to avoid additional charges.",
    },
    {
      id: "5",
      question: "What happens if my battery runs out while I'm riding?",
      answer:
        "If the battery runs out during your ride, the scooter will come to a stop. Make sure to locate the nearest parking zone and secure the scooter there.",
    },
    {
      id: "6",
      question: "Are there age restrictions for renting a scooter?",
      answer:
        "Yes, you must be at least 18 years old to rent a scooter. Some locations may have additional requirements.",
    },
    {
      id: "7",
      question: "Can I ride the scooter on sidewalks?",
      answer:
        "Riding regulations vary by city. Please check local laws within the app to determine where you can ride safely.",
    },
    {
      id: "8",
      question: "How can I contact customer support?",
      answer:
        "You can reach customer support through the app chat feature or via our dedicated email support address provided in the app.",
    },
    {
      id: "9",
      question: "Can I use the scooter for group rides?",
      answer:
        "Each scooter is designed for individual use. Group rides on a single scooter are not permitted for safety reasons.",
    },
  ];
  
  import Icon from '../assets/images/circle.svg'
  import Logo from '../assets/images/plan-1.png'

  import Icon2 from '../assets/images/triangle.svg'
  import Logo2 from '../assets/images/plan-2.png'

  import Icon3 from '../assets/images/hexagon.svg'
  import Logo3 from '../assets/images/plan-3.png'
  ...
  export const plans = [
    {
      ...
      features: [
        ...
        "30 minutes free ride per day",
        "Unlocking using the mobile app",
    ...
    },
    {
      ...
      features: [
        "All Basic features",
        "1 hour of free ride per day",
        "Priority parking zones",
        "Discounts on extended rides",
      ],
      icon: Icon2,
      logo: Logo2,
    },
    {
      ...
      features: [
        ...
        "Personalized statistics via app",
      ],
      icon: Icon3,
      logo: Logo3,
    },
  ...
  import avatar from '../assets/images/testimonials/jessica-saunders.png'
  import avatar2 from '../assets/images/testimonials/mark-erixon.png'
  import avatar3 from '../assets/images/testimonials/melanie-hurst.png'

  import avatar4 from '../assets/images/testimonials/alicia-barker.png'
  import avatar5 from '../assets/images/testimonials/becky-snider.png'
  import avatar6 from '../assets/images/testimonials/jim-bradley.png'
  ...
  export const testimonials = [
    {
      ...
      avatarUrl: avatar,
      comment:
        "I absolutely love the scooters! They’re fast, easy to use, and navigating the city has become a breeze. Highly recommend!",
    },
    {
      id: "1",
      name: "Mark Erixon",
      ...
      avatarUrl: avatar2,
      comment:
        "The service is fantastic! Customer support was very helpful when I had a question. The scooters are always in great condition too!",
    },
    {
      id: "2",
      name: "Melanie Hurst",
      ...
      avatarUrl: avatar3,
      comment:
        "I’ve tried several scooter apps, but this one stands out. The pricing is transparent, and I never have trouble finding a scooter when I need one.",
    },
    {
      id: "3",
      name: "Alicia Barker",
      ...
      avatarUrl: avatar4,
      comment:
        "Using these scooters has transformed my daily commute. They’re eco-friendly, and it's fun to ride. Can't imagine going back to my old routine!",
    },
    {
      id: "4",
      name: "Becky Snider",
      ...
      avatarUrl: avatar5,
      comment:
        "So convenient! The app is user-friendly, and I appreciate the designated parking zones. It makes riding hassle-free.",
    },
    {
      id: "5",
      name: "Jim Bradley",
      ...
      avatarUrl: avatar6,
      comment:
        "I rented a scooter for a day of exploring, and it was the best decision! I loved how affordable it was and felt safe on the road.",
    },
  ];
  ...
  import SocialIcon from '../assets/images/socials/x.svg'
  import SocialIcon2 from '../assets/images/socials/threads.svg'
  import SocialIcon3 from '../assets/images/socials/instagram.svg'
  import SocialIcon4 from '../assets/images/socials/discord.svg'
